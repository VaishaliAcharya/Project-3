...
def get_filters():
    ...
    while True:    
        month = input("please select the month? Note month should be within first six months else type 'all'")
        month = month.lower()
    ...
    while True:
        day = input("please select a particular day, type particluar day else type 'all'")
        day = day.lower()
...
def load_data(city, month, day):
    ...
    """
     # load data file into a dataframe refernce source in readme.txt
...
def user_stats(df, city):
    ...
    if city != 'washington':
        ...
        print("The most recent year of birth is ", mostrecent, "\n")
        print("The most common year of birth is ", mostcommon, "\n")
